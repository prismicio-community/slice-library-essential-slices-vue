<template>
	<section
		...
		class="essential-slice bounded call-to-action"
	>
		<div class="bounded__content call-to-action__content">
			<PrismicImage
			...
			<div class="call-to-action__content">
				<PrismicText
					...
					wrapper="h2"
					class="call-to-action__content__heading"
				/>
				<PrismicRichText
					v-if="$prismic.asText(slice.primary.paragraph)"
					:field="slice.primary.paragraph"
					wrapper="div"
					class="call-to-action__content__paragraph"
				/>
			</div>
			<ButtonLink
